package com.dreamorbit.keychain;
...
import com.dreamorbit.keychain.PrefsStorage.ResultSet;
import com.dreamorbit.keychain.cipherStorage.CipherStorage;
import com.dreamorbit.keychain.cipherStorage.CipherStorage.DecryptionResult;
import com.dreamorbit.keychain.cipherStorage.CipherStorage.EncryptionResult;
import com.dreamorbit.keychain.cipherStorage.CipherStorageFacebookConceal;
import com.dreamorbit.keychain.cipherStorage.CipherStorageKeystoreAESCBC;
import com.dreamorbit.keychain.exceptions.CryptoFailedException;
import com.dreamorbit.keychain.exceptions.EmptyParameterException;
...
public class KeyInfo extends ReactContextBaseJavaModule {
    ...
    public KeyInfo(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    @ReactMethod
    public void setGenericKeyValueForOptions(String service, String key, String value, String minimumSecurityLevel, Promise promise) {
        try {
    ...
    @ReactMethod
    public void getGenericKeyvalueForOptions(String service, Promise promise) {
        try {
            service = getDefaultServiceIfNull(service);
    ...
    @ReactMethod
    public void setInternetCredentialsForServer(@NonNull String server, String key, String value, String minimumSecurityLevel, ReadableMap unusedOptions, Promise promise) {
      setGenericKeyValueForOptions(server, key, value, minimumSecurityLevel, promise);
    }

    @ReactMethod
    public void getInternetCredentialsForServer(@NonNull String server, ReadableMap unusedOptions, Promise promise) {
      getGenericKeyvalueForOptions(server, promise);
    }
