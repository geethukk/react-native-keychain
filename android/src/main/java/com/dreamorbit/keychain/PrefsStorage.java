...
public class PrefsStorage {
    ...
    public void storeEncryptedEntry(@NonNull String service, @NonNull EncryptionResult encryptionResult) {
        ...
        prefs.edit()
                .putString(keyForUsername, Base64.encodeToString(encryptionResult.key, Base64.DEFAULT))
                .putString(keyForPassword, Base64.encodeToString(encryptionResult.value, Base64.DEFAULT))
